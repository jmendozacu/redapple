...
class NeoTheme_Blog_Block_Adminhtml_Post_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form //NeoTheme_Blog_Block_Adminhtml_Form { {
{
    ...
    protected function _prepareForm() {
        ...
        $this->setChild('form_after', $this->getLayout()->createBlock('adminhtml/widget_form_element_dependence')
                ...
                //->addFieldMap($featurePublishField->getHtmlId(), $featurePublishField->getName())
                //->addFieldMap($premiumUnpublishField->getHtmlId(), $premiumUnpublishField->getName())
                //->addFieldMap($premiumPublishField->getHtmlId(), $premiumPublishField->getName())
                ->addFieldDependence(
                ...
                /*->addFieldDependence(
                    $featurePublishField->getName(),
                    $listingTypeField->getName(),
                    NeoTheme_Directory_Model_Listing::TYPE_FEATURED
                )

                ->addFieldDependence(
                    $premiumUnpublishField->getName(),
                    $listingTypeField->getName(),
                    NeoTheme_Directory_Model_Listing::TYPE_PREMIUM
                )
                ->addFieldDependence(
                    $premiumPublishField->getName(),
                    $listingTypeField->getName(),
                    NeoTheme_Directory_Model_Listing::TYPE_PREMIUM
                )*/
